System.register(['three', 'three/examples/jsm/loaders/FontLoader.js', 'three/examples/jsm/controls/OrbitControls.js', 'lil-gui', 'three/examples/jsm/geometries/TextGeometry'], (function () {
  'use strict';
  var THREE, FontLoader, OrbitControls, dat, TextGeometry;
  return {
    setters: [function (module) {
      THREE = module;
    }, function (module) {
      FontLoader = module.FontLoader;
    }, function (module) {
      OrbitControls = module.OrbitControls;
    }, function (module) {
      dat = module;
    }, function (module) {
      TextGeometry = module.TextGeometry;
    }],
    execute: (function () {
      ...
      textureLoader.load("/textures/bricks/color.jpg");
